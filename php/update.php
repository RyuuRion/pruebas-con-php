<?php
     ...
     $query= 'UPDATE usuario SET Email="'.$email.'", usuarioNombre="'.$nombre.'", UsuarioPass="'.$pass.'", usuarioRut="'.$rut.'" WHERE idusuario="'.$idUsuario.'"';
    ...
    <div class="container">
        <div class="row">
           <div class="col-xl-12 mt-5 titulo">
                ...
                ?>
                <h2 style="color: red;">actualizacion no realizada correctamente </h2>
                <a href="/registro/mostrar/" class="btn btn-primary">Volver al menu</a>
                <?php
                    }else{
                ?>
                <h2 style="color: green;">se actualizo al usuario correctamente</h2>
                <a href="/registro/mostrar/" class="btn btn-primary">Volver al menu</a>
                <?php
                    }
                    exit();
