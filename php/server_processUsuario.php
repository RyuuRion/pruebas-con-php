<?php
	...
	*/
	...
	$aColumnas = array( 'idusuario', 'Email', 'usuarioNombre', 'UsuarioPass','usuarioRut' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td style='text-align:center;'><a href='/registro/modificar/index.php?idusuario=<?php echo $row['idusuario']?>' style='color:#fff;'> <i class='far fa-edit'></i></a></td>";
		$row[] = "<td style='text-align:center;'><a href='#' data-href='/php/delete.php?idusuario=<?php echo $row['idusuario']?>' data-toggle='modal' data-target='#confirm-delete' style='color:#fff;'><i class='far fa-trash-alt'></i></a></td>";
